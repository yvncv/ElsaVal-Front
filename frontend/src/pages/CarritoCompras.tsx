...
const CarritoCompras: React.FC = () => {
    ...
    useEffect(() => {
        const fetchCart = async () => {
            try {
                const response = await axios.get(`${apiUrl}/carts/current`, authHeader);
                setCart(response.data);
                setItems(response.data.items); // Asumiendo que la estructura de datos de respuesta tiene un campo 'items'
            } catch (error) {
